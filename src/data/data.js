...
export const experience = [
  {
    ...
    color: "accent",
    bullets: [
      "Core Developer for Data Product Initiatives, leveraging transaction spend analytics to identify and recommend optimal Chase credit card products aligned with customer behavior.",
      "Designed and architected a scalable data pipeline to establish a single source of truth for spend-based data product logic, enabling consistent generation of monthly metrics across all credit card portfolios.",
      "Implemented and productionized AWS Managed Workflows for Apache Airflow (MWAA) to orchestrate mission-critical data pipelines for the Card Data Platform, enabling seamless collaboration and execution across cross-region teams.",
      "Designed and managed a suite of Airflow DAGs to handle weekly and monthly batch processing, ensuring scalable, automated, and highly reliable data workflows with improved operational efficiency.",
      "Enhanced pipeline reliability and observability by implementing monitoring, alerting, and failure recovery mechanisms, reducing downtime and ensuring consistent data availability for downstream consumers.",
      "Authored a high-impact Airflow DAG to analyze transaction data and identify most frequently used credit cards based on customer behavior, driving portfolio optimization and targeted business strategies.",
      "Developed and integrated LLM-powered document review workflows to automate regulatory compliance checks for marketing materials, improving accuracy and reducing manual review effort.",
      "Engineered a Python (Flask)-based microservice leveraging OpenAI and Amazon Bedrock, deployed on Amazon ECS with document storage on Amazon S3, enabling scalable and automated compliance validation.",
    ],
